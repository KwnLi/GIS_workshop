...
url1 <- "https://github.com/KwnLi/GIS_workshop/blob/main/images/url1.gif?raw=true"

url2 <- "https://github.com/KwnLi/GIS_workshop/blob/main/images/url2.gif?raw=true"

url3 <-"https://github.com/KwnLi/GIS_workshop/blob/main/images/url3.png?raw=true"
```
...
# install.packages("sf")  # run this to install the package
library(sf)
